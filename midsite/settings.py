"""
Django settings for midsite project.
...
SECRET_KEY = 'django-insecure-v_83qd)wxj=vq8er%jrn2sy9=(x#8kwv&u4l6=e!x4vq5z9$ci'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Temka0506!',  # Replace with your database password
